    ...
    <li class="nav-item {{ Request::is('product/*') || Request::is('product')   ? 'active' : '' }}">
        ...
        <div id="product"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <h6 class="collapse-header">Custom Components:</h6>
                <a class="collapse-item {{ url()->current() == route('product.create') ? 'active' : '' }}" href="{{ route('product.create') }}">Create Product</a>
                <a class="collapse-item {{ url()->current() == route('product.index') ? 'active' : '' }}" href="{{ route('product.index') }}">All Product</a>
            </div>
        </div>
    </li>
